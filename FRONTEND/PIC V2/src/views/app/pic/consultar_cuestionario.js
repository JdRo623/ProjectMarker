        ...
        <Fragment>
            ...
            <Card className="mb-4">
                <CardBody>
                    ...
                    <p className="mb-3" dangerouslySetInnerHTML={{ __html: cuestionarioUsuario.listado_competencias }} />
                    <p className="text-muted text-small mb-2">Listado Preguntas:</p>
                    <p className="mb-3" dangerouslySetInnerHTML={{ __html: cuestionarioUsuario.listado_preguntas }} />
                    <p className="text-muted text-small mb-2">Listado Preguntas nivel III:</p>
                    <p className="mb-3" dangerouslySetInnerHTML={{ __html: cuestionarioUsuario.listado_preguntas_seccion_iii }} />
                </CardBody>
            </Card>
        </Fragment>
    )
