...
const rutaAprendizaje = {
    ...
    listado_competencias: [
        ...
        {
            nombre_competencia: "Identificación de conductas objeto de sanción fiscal",
            colorEstado_basico: "primary", //primary/#DFD800/error
            colorEstado_medio: "#DFD800", //primary/#DFD800/error
            colorEstado_alto: "error", //primary/#DFD800/error
            colorEstado_superior: "error", //primary/#DFD800/error
            listado_cursos_basicos: [{
                idCurso: "01",
                nombreCurso: "Diplomado NIC-NIIF",
                fechaActualizacion: "27/05/2020",
                estado: "Aprobado",
                nivel: "BÁSICO",
                colorEstado: "primary" //primary/#DFD800/error
            },
            {
                idCurso: "02",
                nombreCurso: "Modelos de negocio y financiación",
            ...
            listado_cursos_medios: [
                {
                    ...
                    estado: "Cursando",
                    nivel: "MEDIO",
                    colorEstado: "#DFD800" //primary/#DFD800/error
                },
                {
                    idCurso: "04",
                    nombreCurso: "Investigación del fraude fiscal",
            ...
            listado_cursos_superiores: [
                {
                    ...
                    estado: "Por Cursar",
                    nivel: "SUPERIOR",
                    colorEstado: "error" //primary/#DFD800/error
                },
                {
                    idCurso: "08",
                    nombreCurso: "Análisis de datos y toma de decisiones en la investigación fiscal",
