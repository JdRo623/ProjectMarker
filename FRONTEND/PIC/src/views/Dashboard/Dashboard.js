    ...
    {/*  <GridContainer>
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Avance diario</h4>
              <p className={classes.cardCategory}>
                <span className={classes.successText}>
                  <ArrowUpward className={classes.upArrowCardCategory} /> 55%
                </span>{" "}
                incremento in actividades realizadas hoy.
              </p>
            </CardBody>
            <CardFooter chart>
              <div className={classes.stats}>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Avance de competencias</h4>
              <p className={classes.cardCategory}>Avance general</p>
            </CardBody>
            <CardFooter chart>
              <div className={classes.stats}>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Cursos terminados</h4>
              <p className={classes.cardCategory}>En el ultimo año</p>
            </CardBody>
            <CardFooter chart>
              <div className={classes.stats}>
                <AccessTime /> Han transcurrido 363 dias del año
              </div>
            </CardFooter>
          </Card>
        </GridItem>
