    ...
    try {
        ...
        var reporteUsuarios = async (req,res) => {
            ...
            worksheetOut.columns = [
                ...
                {header:'Tiene_personas_a_cargo',key:'Tiene_personas_a_cargo'},
            ...
            workbookOut.xlsx.writeFile(documentname).then(()=>{
                base64.encode(documentname, function(err,base64String){
                    ...
                    return res.status(200).send({
                        estado: 'Descargado',
                        message: util.format("Archivo de usuarios generado exitosamente"),
    ...
    try {
        ...
        var preguntas_seccion1 = async(req,res) =>{
            ...
            worksheetOut.columns = [
                ...
                {header:'enunciado_respuesta',key:'enunciado_respuesta'},
                {header:'estado',key:'estado'}
            ];
